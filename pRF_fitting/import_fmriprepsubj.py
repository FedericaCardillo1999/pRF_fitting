...
source_dir = f'{DERIV_PATH}/fmriprep/{subject}/ses-01/anat' 
...
# %%
cortex.freesurfer.import_subj(f'sub-{subject_id}',freesurfer_subject_dir=f'/scratch/hb-EGRET-AAA/projects/EGRET+/derivatives/freesurfer')
